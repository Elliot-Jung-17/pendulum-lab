...
| `npm test` / `test:quick` / `test:slow` | Vitest unit suite (940 tests across 141 files; synced from `reports/vitest-results.json`) plus quick/slow tiers for local and CI iteration |
